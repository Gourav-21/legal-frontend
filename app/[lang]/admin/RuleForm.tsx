...
interface RuleFormProps {
  ...
  onAddCheck: () => void;
  onUpdateCheck: (index: number, field: keyof RuleFormProps['ruleChecks'][0], value: string) => void;
          ...
          <form onSubmit={onFormSubmit}>
            <div className="row">
              <div className="col-md-6">
                <div className="mb-3">
                  <label htmlFor="ruleId" className="form-label" style={{ fontFamily: "'Space Grotesk', sans-serif", color: 'rgba(15, 15, 20, 0.7)' }}>
                    <i className="bi bi-hash me-1"></i>{dictionary.admin.ruleForm.ruleId}{isEditing ? '*' : ` ${dictionary.admin.ruleForm.autoGenerated}`}
                  </label>
                  <input
                    type="text"
                    ...
                    onChange={(e) => onFormDataChange({ rule_id: e.target.value })}
                    placeholder={isEditing ? dictionary.admin.ruleForm.ruleIdPlaceholder : dictionary.admin.ruleForm.autoGeneratedHelp}
                  ...
                  {formErrors.rule_id && <div className="invalid-feedback">{formErrors.rule_id}</div>}
                    <div className="form-text text-muted">
                      {dictionary.admin.ruleForm.autoGeneratedHelp}
                    </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-3">
                    ...
                    <input
                      ...
                      onChange={(e) => onFormDataChange({ effective_to: e.target.value })}
            ...
            <div className="mt-4">
              ...
              <div className="card mb-3" style={{ backgroundColor: 'rgba(253, 207, 111, 0.1)', border: '2px solid #FDCF6F', borderRadius: '12px', boxShadow: '0 4px 12px rgba(253, 207, 111, 0.15)' }}>
                <div className="card-header" style={{ backgroundColor: '#FDCF6F', color: '#0F0F14', borderRadius: '12px 12px 0 0', border: 'none' }}>
                  <h6 className="mb-0" style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '0.95rem', fontWeight: '600' }}>
                    <i className="bi bi-plus-circle me-2"></i>{dictionary.admin.ruleForm.addNewCheck}
                  </h6>
                </div>
                  ...
                  <div className="d-flex gap-2 justify-content-between align-items-center">
                    ...
                    <div className="d-flex gap-2">
                      ...
                      <button
                        ...
                        onClick={onAddCheck}
                      >
                        <i className="bi bi-plus-circle me-1"></i> {dictionary.admin.ruleForm.addCheck}
                      </button>
                      <button
                        type="submit"
                        className="btn"
